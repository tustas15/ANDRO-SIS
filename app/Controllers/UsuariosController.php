...
class UsuariosController extends BaseController
{
    ...
    public function guardarUsuario()
    {
        ...
        $validation->setRules([
            ...
            'cedula' => [
                'rules' => 'required|max_length[20]|is_unique[usuarios.cedula]',
                'errors' => [
            ...
            'imagen_perfil' => 'max_size[imagen_perfil,1024]|is_image[imagen_perfil]|ext_in[imagen_perfil,png,jpg,jpeg]'
        ]);
        ...
        if ($imagen->isValid() && !$imagen->hasMoved()) {
            log_message('info', 'Subiendo imagen: ' . $imagen->getName());
            ...
            log_message('error', 'Error al subir imagen: ' . $imagen->getErrorString());
        }
    ...
    public function actualizarPerfil()
    {
        ...
        $imagen = $this->request->getFile('imagen_perfil');
        if ($imagen->isValid() && !$imagen->hasMoved()) {
            // En el controlador, después de $imagen->isValid()
            log_message('error', 'Error al subir imagen: ' . $imagen->getErrorString());
