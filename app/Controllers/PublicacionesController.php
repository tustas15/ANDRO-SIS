...
{  
        ...
        if ($perfil === 'contratista') {
            return redirect()->to('contratista/publicacion');
        }
    // Obtener datos para el panel de sugerencias  
    $sugerencias = [  
        // Llama a getContratistasConEstadisticas para asegurarte que solo obtiene contratistas activos  
    ...
    $data = [  
        ...
        'contratistas' => $sugerencias['contratistas'], // usando las sugerencias actualizadas  
        'proyectos' => $this->proyectoModel->orderBy('fecha_publicacion', 'DESC')->findAll(5),  
        'categorias' => $this->categoriaModel->findAll()  
    ];  
...
{  
    ...
    // Asegúrate de que solo obtienes contratistas activos aquí también  
    $data = [  
        'contratistas' => $this->usuarioModel->getContratistasConEstadisticas(), // obteniendo solo activos  
