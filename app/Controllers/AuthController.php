...
class AuthController extends BaseController
{
    ...
    public function login()
    {
        ...
        // Redirección basada en el perfil
        if ($user['perfil'] === 'admin' || $user['perfil'] === 'publico') {
            return redirect()->to('newsfeed');
        } elseif ($user['perfil'] === 'contratista') {
            return redirect()->to('contratista/publicacion');
        }

        return redirect()->to('newsfeed'); // Redirección por defecto
    }
    ...
    public function processRegister()
    {
        ...
        $validation->setRules([
            ...
            'cedula' => 'required|max_length[20]|is_unique[usuarios.cedula]',
            'contrasena' => 'required|min_length[6]'            
        ]);
