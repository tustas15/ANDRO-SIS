    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                ...
                <div class="wrap-input100 validate-input" data-validate="Cédula o Ruc requerida">
                    <input class="input100" type="text" name="cedula" placeholder="Cédula" required>
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <?php if (session('errors.cedula')): ?>
                    <div class="text-danger p-b-10"><?= session('errors.cedula') ?></div>
                <?php endif; ?>
