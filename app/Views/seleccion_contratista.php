    ...
    <div class="row shadow">
        <div class="row_contain_profilephotospage">
            ...
            <div class="feed_content_image">
                <span>
                    <strong>Nombres:</strong><?= $contratista['nombre'] ?> <?= $contratista['apellido'] ?><br>
                    <strong>Correo:</strong> <?= $contratista['correo'] ?><br>
                    <!-- Mostrar cédula -->
                    <strong>Cédula/RUC:</strong> <?= $contratista['cedula'] ?? 'No registrado' ?>
                </span>
            </div>
        </div>
    </div>
                ...
                <div class="publish">
                    <div class="feed_content_image bg-light cursor-pointer"
                        ...
                        <small class="text-muted">
                            <strong>Estado:</strong><?= ucfirst($proyecto['etapa']) ?><br>
                            <strong>Presupuesto:</strong> $<?= number_format($proyecto['presupuesto'], 2) ?><br>
                            <!-- Agregar estas líneas -->
                            <strong>Inicio:</strong> <?= date('d/m/Y', strtotime($proyecto['fecha_publicacion'])) ?><br>
                            <strong>Fin estimado:</strong> <?= $proyecto['fecha_fin'] ? date('d/m/Y', strtotime($proyecto['fecha_fin'])) : 'Por definir' ?>
                        </small>
