    ...
    <div class="modal modal-comments">
        ...
        <div class="modal-content">
            <ul>
                <li>
                    <a href="#">
                        <img src="../../../public/images/user-7.jpg" alt="" />
                ...
                <li>
                    <a href="#">
                        <img src="../../../public/images/user-6.jpg" alt="" />
                ...
                <li>
                    <a href="#">
                        <img src="../../../public/images/user-3.jpg" alt="" />
    ...
    <div class="modal modal-friends">
        ...
        <div class="modal-content">
            <ul>
                <li>
                    <a href="#">
                        <img src="../../../public/images/user-2.jpg" alt="" />
                ...
                <li>
                    <a href="#">
                        <img src="../../../public/images/user-4.jpg" alt="" />
    ...
    <div class="mobilemenu">
        ...
        <div class="mobilemenu_profile">
            <img id="mobilemenu_portada" src="../../../public/images/portada.jpg" />
            <div class="mobilemenu_profile">
                <img id="mobilemenu_profile_pic" src="../../../public/images/user.jpg" /><br>
