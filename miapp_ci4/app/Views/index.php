            ...
            <?php foreach ($publicaciones as $publicacion): ?>
                <div class="feed">
                    <div class="feed_title">
                        ...
                        <span><b><?= htmlspecialchars($publicacion['contratista_nombre'] . ' ' . $publicacion['contratista_apellido']) ?> </b><br> <b>PROYECTO:</b> <a href="feed.html"><?= htmlspecialchars($publicacion['proyecto_titulo']) ?></a><br><b><?= htmlspecialchars($publicacion['titulo']) ?></b><p><?= date('d M Y', strtotime($publicacion['fecha_publicacion'])) ?></p></span>
                    </div>
                    <div class="feed_content">
                        <div class="feed_content_image">
                            <p><?= nl2br(htmlspecialchars($publicacion['descripcion'])) ?></p>
                            <a href="feed.html"><img src="images/<?= htmlspecialchars($publicacion['imagen']) ?>" alt="" /></a>
                        </div>
                    </div>
                    <div class="feed_footer">
                        ...
                        <ul class="feed_footer_right">
                            <li>
                                <a href="feed.html" style="color:#515365;"><li class="hover-orange"><i class="fa fa-comments-o"></i> <span class="total-comentario"><?= obtenerTotalComentarios($publicacion['id_publicacion'], $conn) ?></span></li></a>
                            </li>
                        </ul>
                    </div>
                </div>
